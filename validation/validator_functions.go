...
func required(_ string, value interface{}, _ string) (valid bool, err error) {
...
func min(_ string, value interface{}, base string) (valid bool, err error) {
	minVal, err := strconv.Atoi(base)
	if err != nil {
		panic("Invalid arguments for validator: " + base)
	}
